// REALNKEO payment server (Node.js + Express + Razorpay)
// 1) npm install
...
const catalog={
1:{name:"Cyber Warrior",price:49},2:{name:"Purple Dream",price:39},3:{name:"Anime Night",price:49},
4:{name:"Moon Forest",price:29},5:{name:"Neon Battle",price:59},6:{name:"Sakura Sky",price:39},
7:{name:"Cosmic Earth",price:49},8:{name:"Dark Gaming Pack",price:99}};
...
app.post("/api/create-order",async(req,res)=>{
 try{
  ...
  const ids=req.body.items||[]; const amount=ids.reduce((s,id)=>s+(catalog[id]?.price||0),0)*100;
...
app.post("/api/verify-payment",(req,res)=>{
 ...
 // IMPORTANT: Replace this with your own database/order lookup and a short-lived signed download URL.
